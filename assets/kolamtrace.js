...
new KolamAnimator({
    fileInputId:'kolam-upload', previewImgId:'preview-img', placeholderId:'preview-placeholder', animateBtnId:'animate-btn', canvasId:'animationCanvas', backBtnId:'back20', forwardBtnId:'forward20', sliderId:'frameSlider'
});
